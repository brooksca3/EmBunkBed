...
# wp1k model
state_model = torch.load("/scratch/gpfs/cabrooks/bunk_models/wp10k_testing_768_32/checkpoint-175086/my_custom_model.pth")
...
training_args = TrainingArguments(
    ...
    logging_steps=200,
    save_steps=save_every,
    output_dir=filestem + '/char_10k_combined_test' + str(batch_size),
    per_device_train_batch_size=batch_size,
    num_train_epochs=epochs
    # learning_rate=5e-05
)
...
model.save_pretrained(filestem + '/char_10k_combined_test' + str(batch_size) + '/tester')
